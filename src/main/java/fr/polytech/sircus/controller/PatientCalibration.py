...
def plot(calibration_result, validation_result):
    ...
    plot_canvas = Canvas(plot_window, width=3 * plot_window.winfo_screenwidth() / 4,
                         height=plot_window.winfo_screenheight(),
                         borderwidth=0, highlightthickness=0, bg='white')
    plot_canvas.pack(anchor=W, side=LEFT)

    # Result labels
    average_accuracy_left = Label(plot_window,
                                  text="Précision moyenne gauche : " + str(validation_result.average_accuracy_left),
                                  font=("Arial", 10))
    average_accuracy_left.pack(anchor=E, side=TOP, fill=X, pady=20)
    average_accuracy_right = Label(plot_window,
                                   text="Précision moyenne droite : " + str(validation_result.average_accuracy_right),
                                   font=("Arial", 10))
    average_accuracy_right.pack(anchor=E, side=TOP, fill=X, pady=20)
    average_precision_left = Label(plot_window, text="Précision moyenne gauche (deg) : " + str(
        validation_result.average_precision_left), font=("Arial", 10))
    average_precision_left.pack(anchor=E, side=TOP, fill=X, pady=20)
    average_precision_right = Label(plot_window, text="Précision moyenne droite (deg) : " + str(
        validation_result.average_precision_right), font=("Arial", 10))
    average_precision_right.pack(anchor=E, side=TOP, fill=X, pady=20)
    average_precision_rms_left = Label(plot_window, text="Précision quadratique moyenne gauche : " + str(
        validation_result.average_precision_rms_left), font=("Arial", 10))
    average_precision_rms_left.pack(anchor=E, side=TOP, fill=X, pady=20)
    average_precision_rms_right = Label(plot_window, text="Précision quadratique moyenne droite : " + str(
        validation_result.average_precision_rms_right), font=("Arial", 10))
